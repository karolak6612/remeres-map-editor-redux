...
bool VulkanContext::Initialize(const std::vector<const char*>& requiredExtensions) {
    try {
        ...
        spdlog::error("Failed to initialize Vulkan Context: {}", e.what());
        Cleanup();
        return false;
    }
}
...
void VulkanContext::CreateInstance(const std::vector<const char*>& requiredExtensions) {
    ...
    appInfo.pApplicationName = "Remere's Map Editor";
    appInfo.applicationVersion = VK_MAKE_VERSION(1, 0, 0);
    appInfo.pEngineName = "RME Vulkan Engine";
...
void VulkanContext::CreateCommandPool() {
    QueueFamilyIndices queueFamilyIndices = FindQueueFamilies(physicalDevice, VK_NULL_HANDLE);
