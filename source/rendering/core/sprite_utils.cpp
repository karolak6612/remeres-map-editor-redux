...
std::unique_ptr<uint8_t[]> SpriteUtils::Decompress(std::span<const uint8_t> dump, bool use_alpha, int id) {
...
void SpriteUtils::ColorizeTemplatePixels(uint8_t* dest, const uint8_t* mask, size_t pixelCount, int lookHead, int lookBody, int lookLegs, int lookFeet, bool destHasAlpha) {
