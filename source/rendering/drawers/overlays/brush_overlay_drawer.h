...
private:
    ...
    void drawDragging(
        const DrawContext& ctx, ItemDrawer* item_drawer, SpriteDrawer* sprite_drawer, Editor& editor, Brush* brush,
        const glm::vec4& brushColor, BrushShape brush_shape, int last_click_map_x, int last_click_map_y
    );
    void drawStationary(
        const DrawContext& ctx, ItemDrawer* item_drawer, SpriteDrawer* sprite_drawer, CreatureDrawer* creature_drawer,
