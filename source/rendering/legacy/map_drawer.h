...
class MapDrawer {
	...
	std::unique_ptr<rme::render::BrushRenderer> brush_renderer;
	std::unique_ptr<rme::render::SelectionRenderer> selection_renderer;
	std::unique_ptr<rme::render::UIRenderer> ui_renderer;
	std::unique_ptr<rme::render::GridRenderer> grid_renderer;
	std::unique_ptr<rme::render::TooltipRenderer> tooltip_renderer;
	...
	rme::render::RenderContext render_context;
