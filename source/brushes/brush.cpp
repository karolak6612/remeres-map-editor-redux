...
void Brushes::init() {
	...
	addManagedBrush(g_brush_manager.pz_brush, static_cast<uint16_t>(TileMapFlag::PROTECTIONZONE));
	addManagedBrush(g_brush_manager.rook_brush, static_cast<uint16_t>(TileMapFlag::NOPVP));
	addManagedBrush(g_brush_manager.nolog_brush, static_cast<uint16_t>(TileMapFlag::NOLOGOUT));
	addManagedBrush(g_brush_manager.pvp_brush, static_cast<uint16_t>(TileMapFlag::PVPZONE));
