	...
	while (!borderList.empty()) {
		...
		for (int32_t i = 0; i < 4; ++i) {
			...
			if (borderCluster.border->tiles[direction] != 0) {
				tile->items.insert(tile->items.begin(), Item::Create(borderCluster.border->tiles[direction]));
			} else {
				if (direction == NORTHWEST_DIAGONAL) {
					if (borderCluster.border->tiles[WEST_HORIZONTAL] != 0 && borderCluster.border->tiles[NORTH_HORIZONTAL] != 0) {
						tile->items.insert(tile->items.begin(), Item::Create(borderCluster.border->tiles[WEST_HORIZONTAL]));
						tile->items.insert(tile->items.begin(), Item::Create(borderCluster.border->tiles[NORTH_HORIZONTAL]));
					}
					...
					if (borderCluster.border->tiles[EAST_HORIZONTAL] != 0 && borderCluster.border->tiles[NORTH_HORIZONTAL] != 0) {
						tile->items.insert(tile->items.begin(), Item::Create(borderCluster.border->tiles[EAST_HORIZONTAL]));
						tile->items.insert(tile->items.begin(), Item::Create(borderCluster.border->tiles[NORTH_HORIZONTAL]));
					}
					...
					if (borderCluster.border->tiles[SOUTH_HORIZONTAL] != 0 && borderCluster.border->tiles[WEST_HORIZONTAL] != 0) {
						tile->items.insert(tile->items.begin(), Item::Create(borderCluster.border->tiles[SOUTH_HORIZONTAL]));
						tile->items.insert(tile->items.begin(), Item::Create(borderCluster.border->tiles[WEST_HORIZONTAL]));
					}
