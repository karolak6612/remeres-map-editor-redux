...
bool GroundBrushLoader::loadOptional(GroundBrush& brush, const pugi::xml_node& childNode, wxArrayString& warnings) {
...
bool GroundBrushLoader::loadBorder(GroundBrush& brush, const pugi::xml_node& childNode, wxArrayString& warnings) {
	pugi::xml_attribute attribute;
...
void GroundBrushLoader::loadFriend(GroundBrush& brush, const pugi::xml_node& childNode, wxArrayString& warnings) {
...
void GroundBrushLoader::loadEnemy(GroundBrush& brush, const pugi::xml_node& childNode, wxArrayString& warnings) {
	const std::string_view name = childNode.attribute("name").as_string();
	if (!name.empty()) {
		if (name == "all") {
			brush.friends.push_back(0xFFFFFFFF);
