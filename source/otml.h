...
using OTMLNodePtr = boost::shared_ptr<OTMLNode>;
using OTMLNodeEnableSharedFromThis = boost::enable_shared_from_this<OTMLNode>;
using OTMLDocumentPtr = boost::shared_ptr<OTMLDocument>;
using OTMLNodeWeakPtr = boost::weak_ptr<OTMLNode>;
#endif
