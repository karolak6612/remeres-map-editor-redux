...
public:
	...
	// Iterator support for MapIterator Ă˘â‚¬â€ť const-only to protect sorted invariant
	auto begin() const {
...
protected:
	BaseMap& map;
	std::vector<CellEntry> cells_; // Sorted by key Ă˘â‚¬â€ť contiguous, cache-friendly
	...
	// Allocates GridCell immediately on insertion Ă˘â‚¬â€ť no null entries left behind.
