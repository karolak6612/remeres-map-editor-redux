...
constexpr TileMapFlags& operator|=(TileMapFlags& a, TileMapFlags b) { a = a | b; return a; }
constexpr TileMapFlags& operator&=(TileMapFlags& a, TileMapFlags b) { a = a & b; return a; }
constexpr TileMapFlags& operator^=(TileMapFlags& a, TileMapFlags b) { a = a ^ b; return a; }
...
constexpr TileStatFlags& operator|=(TileStatFlags& a, TileStatFlags b) { a = a | b; return a; }
constexpr TileStatFlags& operator&=(TileStatFlags& a, TileStatFlags b) { a = a & b; return a; }
constexpr TileStatFlags& operator^=(TileStatFlags& a, TileStatFlags b) { a = a ^ b; return a; }
