...
EditorPage::EditorPage(wxWindow* parent) : PreferencesPage(parent) {
	...
	sizer->Add(group_actions_chkbox, wxSizerFlags().Border(wxLEFT | wxTOP, FROM_DIP(this, 5)));
	...
	sizer->Add(duplicate_id_warn_chkbox, wxSizerFlags().Border(wxLEFT | wxTOP, FROM_DIP(this, 5)));
	...
	sizer->Add(house_remove_chkbox, wxSizerFlags().Border(wxLEFT | wxTOP, FROM_DIP(this, 5)));
	...
	sizer->Add(auto_assign_doors_chkbox, wxSizerFlags().Border(wxLEFT | wxTOP, FROM_DIP(this, 5)));
	...
	sizer->Add(doodad_erase_same_chkbox, wxSizerFlags().Border(wxLEFT | wxTOP, FROM_DIP(this, 5)));
	...
	sizer->Add(eraser_leave_unique_chkbox, wxSizerFlags().Border(wxLEFT | wxTOP, FROM_DIP(this, 5)));
	...
	sizer->Add(auto_create_spawn_chkbox, wxSizerFlags().Border(wxLEFT | wxTOP, FROM_DIP(this, 5)));
	...
	sizer->Add(allow_multiple_orderitems_chkbox, wxSizerFlags().Border(wxLEFT | wxTOP, FROM_DIP(this, 5)));
	...
	sizer->Add(merge_move_chkbox, wxSizerFlags().Border(wxLEFT | wxTOP, FROM_DIP(this, 5)));
	...
	sizer->Add(merge_paste_chkbox, wxSizerFlags().Border(wxLEFT | wxTOP, FROM_DIP(this, 5)));
