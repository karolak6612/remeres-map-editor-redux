...
namespace IngamePreview {
	...
	IngamePreviewWindow::IngamePreviewWindow(wxWindow* parent) :
		...
		follow_btn->SetBitmap(wxMaterialDesignArtProvider::GetBitmap(wxART_MY_LOCATION, wxART_CLIENT_MATERIAL_FILLED, wxSize(FromDIP(16), FromDIP(16)), wxColour(76, 175, 80)));
		...
		lighting_btn->SetBitmap(wxMaterialDesignArtProvider::GetBitmap(wxART_WB_SUNNY, wxART_CLIENT_MATERIAL_FILLED, wxSize(FromDIP(16), FromDIP(16)), wxColour(255, 235, 59)));
		...
		outfit_btn->SetBitmap(wxMaterialDesignArtProvider::GetBitmap(wxART_ACCOUNT_CIRCLE, wxART_CLIENT_MATERIAL_FILLED, wxSize(FromDIP(16), FromDIP(16)), wxColour(96, 125, 139)));
		...
		viewport_w_down->SetBitmap(wxMaterialDesignArtProvider::GetBitmap(wxART_DO_NOT_DISTURB_ON, wxART_CLIENT_MATERIAL_FILLED, wxSize(FromDIP(16), FromDIP(16)), wxColour(0, 150, 136)));
		...
		viewport_w_up->SetBitmap(wxMaterialDesignArtProvider::GetBitmap(wxART_ADD_CIRCLE, wxART_CLIENT_MATERIAL_FILLED, wxSize(FromDIP(16), FromDIP(16)), wxColour(0, 150, 136)));
		...
		viewport_h_down->SetBitmap(wxMaterialDesignArtProvider::GetBitmap(wxART_DO_NOT_DISTURB_ON, wxART_CLIENT_MATERIAL_FILLED, wxSize(FromDIP(16), FromDIP(16)), wxColour(0, 150, 136)));
		...
		viewport_h_up->SetBitmap(wxMaterialDesignArtProvider::GetBitmap(wxART_ADD_CIRCLE, wxART_CLIENT_MATERIAL_FILLED, wxSize(FromDIP(16), FromDIP(16)), wxColour(0, 150, 136)));
	...
	void IngamePreviewWindow::SetFollowSelection(bool follow) {
		...
		if (follow_selection) {
			...
			follow_btn->SetBitmap(wxMaterialDesignArtProvider::GetBitmap(wxART_MY_LOCATION, wxART_CLIENT_MATERIAL_FILLED, wxSize(FromDIP(16), FromDIP(16)), wxColour(158, 158, 158)));
		}
