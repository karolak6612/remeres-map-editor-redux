...
namespace IngamePreview {
	...
	IngamePreviewWindow::IngamePreviewWindow(wxWindow* parent) :
		...
		// Toggles
		follow_btn = new wxToggleButton(this, ID_FOLLOW_SELECTION, "", wxDefaultPosition, wxDefaultSize);
		...
		lighting_btn = new wxToggleButton(this, ID_ENABLE_LIGHTING, "", wxDefaultPosition, wxDefaultSize);
		...
		outfit_btn = new wxButton(this, ID_CHOOSE_OUTFIT, "", wxDefaultPosition, wxDefaultSize);
		...
		// Viewport Controls
		// Width
		viewport_w_down = new wxButton(this, ID_VIEWPORT_W_DOWN, "", wxDefaultPosition, wxDefaultSize);
		...
		viewport_x_text = new wxTextCtrl(this, wxID_ANY, "15", wxDefaultPosition, wxDefaultSize, wxTE_READONLY | wxTE_CENTER);
		toolbar_sizer->Add(viewport_x_text, 0, wxALL | wxALIGN_CENTER_VERTICAL, 1);

		viewport_w_up = new wxButton(this, ID_VIEWPORT_W_UP, "", wxDefaultPosition, wxDefaultSize);
		...
		// Height
		viewport_h_down = new wxButton(this, ID_VIEWPORT_H_DOWN, "", wxDefaultPosition, wxDefaultSize);
		...
		viewport_y_text = new wxTextCtrl(this, wxID_ANY, "11", wxDefaultPosition, wxDefaultSize, wxTE_READONLY | wxTE_CENTER);
		toolbar_sizer->Add(viewport_y_text, 0, wxALL | wxALIGN_CENTER_VERTICAL, 1);

		viewport_h_up = new wxButton(this, ID_VIEWPORT_H_UP, "", wxDefaultPosition, wxDefaultSize);
