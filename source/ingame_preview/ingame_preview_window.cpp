...
namespace IngamePreview {
	...
	IngamePreviewWindow::IngamePreviewWindow(wxWindow* parent) :
		...
		// Toggles
		follow_btn = new wxToggleButton(this, ID_FOLLOW_SELECTION, "", wxDefaultPosition, FromDIP(wxSize(32, 28)));
		...
		lighting_btn = new wxToggleButton(this, ID_ENABLE_LIGHTING, "", wxDefaultPosition, FromDIP(wxSize(32, 28)));
		...
		outfit_btn = new wxButton(this, ID_CHOOSE_OUTFIT, "", wxDefaultPosition, FromDIP(wxSize(32, 28)));
		...
		// Sliders
		ambient_slider = new wxSlider(this, ID_AMBIENT_SLIDER, 128, 0, 255, wxDefaultPosition, FromDIP(wxSize(80, -1)));
		ambient_slider->SetToolTip("Ambient Light");
		toolbar_sizer->Add(ambient_slider, 0, wxALL | wxALIGN_CENTER_VERTICAL, 1);

		intensity_slider = new wxSlider(this, ID_INTENSITY_SLIDER, 100, 0, 200, wxDefaultPosition, FromDIP(wxSize(80, -1)));
		...
		// Viewport Controls
		// Width
		viewport_w_down = new wxButton(this, ID_VIEWPORT_W_DOWN, "", wxDefaultPosition, FromDIP(wxSize(28, 28)));
		...
		viewport_x_text = new wxTextCtrl(this, wxID_ANY, "15", wxDefaultPosition, FromDIP(wxSize(36, -1)), wxTE_READONLY | wxTE_CENTER);
		toolbar_sizer->Add(viewport_x_text, 0, wxALL | wxALIGN_CENTER_VERTICAL, 1);

		viewport_w_up = new wxButton(this, ID_VIEWPORT_W_UP, "", wxDefaultPosition, FromDIP(wxSize(28, 28)));
		...
		// Height
		viewport_h_down = new wxButton(this, ID_VIEWPORT_H_DOWN, "", wxDefaultPosition, FromDIP(wxSize(28, 28)));
		...
		viewport_y_text = new wxTextCtrl(this, wxID_ANY, "11", wxDefaultPosition, FromDIP(wxSize(36, -1)), wxTE_READONLY | wxTE_CENTER);
		toolbar_sizer->Add(viewport_y_text, 0, wxALL | wxALIGN_CENTER_VERTICAL, 1);

		viewport_h_up = new wxButton(this, ID_VIEWPORT_H_UP, "", wxDefaultPosition, FromDIP(wxSize(28, 28)));
	...
	IngamePreviewWindow::~IngamePreviewWindow() {
		spdlog::debug("IngamePreviewWindow destructor started");
		spdlog::default_logger()->flush();

		spdlog::debug("IngamePreviewWindow destructor - stopping update_timer");
		spdlog::default_logger()->flush();
		update_timer.Stop();

		spdlog::debug("IngamePreviewWindow destructor finished");
		// spdlog::default_logger()->flush();
	}
