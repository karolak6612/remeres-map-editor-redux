...
FindItemDialog::FindItemDialog(wxWindow *parent, const wxString &title,
                               bool onlyPickupables /* = false*/)
    : wxDialog(parent, wxID_ANY, title, wxDefaultPosition, wxSize(800, 600),
               wxDEFAULT_DIALOG_STYLE),
      input_timer(this), result_brush(nullptr), result_id(0),
  ...
  wxString radio_boxChoices[] = {"Find by Server ID", "Find by Client ID",
                                 "Find by Name", "Find by Types",
                                 "Find by Properties"};

  int radio_boxNChoices = sizeof(radio_boxChoices) / sizeof(wxString);
  options_radio_box = newd wxRadioBox(
      this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize,
      radio_boxNChoices, radio_boxChoices, 1, wxRA_SPECIFY_COLS);
  options_radio_box->SetSelection(SearchMode::ServerIDs);
  options_box_sizer->Add(options_radio_box, 0, wxALL | wxEXPAND, 5);

  wxStaticBoxSizer *server_id_box_sizer = newd wxStaticBoxSizer(
      newd wxStaticBox(this, wxID_ANY, "Server ID"), wxVERTICAL);
  server_id_spin =
      newd wxSpinCtrl(server_id_box_sizer->GetStaticBox(), wxID_ANY,
                      wxEmptyString, wxDefaultPosition, wxDefaultSize,
                      wxSP_ARROW_KEYS, 100, g_items.getMaxID(), 100);
  server_id_spin->SetToolTip("Search by server ID");
  server_id_box_sizer->Add(server_id_spin, 0, wxALL | wxEXPAND, 5);

  invalid_item =
      newd wxCheckBox(server_id_box_sizer->GetStaticBox(), wxID_ANY,
                      "Force select", wxDefaultPosition, wxDefaultSize, 0);
  invalid_item->SetToolTip(
      "Force choose item ID that does not appear on the list.");
  server_id_box_sizer->Add(invalid_item, 1, wxALL | wxEXPAND, 5);

  options_box_sizer->Add(server_id_box_sizer, 1, wxALL | wxEXPAND, 5);

  wxStaticBoxSizer *client_id_box_sizer = newd wxStaticBoxSizer(
      newd wxStaticBox(this, wxID_ANY, "Client ID"), wxVERTICAL);
  client_id_spin = newd wxSpinCtrl(
      client_id_box_sizer->GetStaticBox(), wxID_ANY, wxEmptyString,
      wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 100,
      g_gui.sprite_database.getItemSpriteMaxID(), 100);
  ...
  wxStaticBoxSizer *name_box_sizer = newd wxStaticBoxSizer(
      newd wxStaticBox(this, wxID_ANY, "Name"), wxVERTICAL);
  name_text_input =
      newd wxTextCtrl(name_box_sizer->GetStaticBox(), wxID_ANY, wxEmptyString,
  ...
  wxStaticBoxSizer *type_box_sizer = newd wxStaticBoxSizer(
      newd wxStaticBox(this, wxID_ANY, "Types"), wxVERTICAL);

  wxString types_choices[] = {
      "Depot",       "Mailbox",  "Trash Holder", "Container", "Door",
      "Magic Field", "Teleport", "Bed",          "Key",       "Podium"};

  int types_choices_count = sizeof(types_choices) / sizeof(wxString);
  types_radio_box =
      newd wxRadioBox(type_box_sizer->GetStaticBox(), wxID_ANY, wxEmptyString,
                      wxDefaultPosition, wxDefaultSize, types_choices_count,
                      types_choices, 1, wxRA_SPECIFY_COLS);
  ...
  wxStaticBoxSizer *properties_box_sizer = newd wxStaticBoxSizer(
      newd wxStaticBox(this, wxID_ANY, "Properties"), wxVERTICAL);

  unpassable =
      newd wxCheckBox(properties_box_sizer->GetStaticBox(), wxID_ANY,
                      "Unpassable", wxDefaultPosition, wxDefaultSize, 0);
  unpassable->SetToolTip("Item blocks movement");
  properties_box_sizer->Add(unpassable, 0, wxALL, 5);

  unmovable = newd wxCheckBox(properties_box_sizer->GetStaticBox(), wxID_ANY,
                              "Unmovable", wxDefaultPosition, wxDefaultSize, 0);
  unmovable->SetToolTip("Item cannot be moved");
  properties_box_sizer->Add(unmovable, 0, wxALL, 5);

  block_missiles =
      newd wxCheckBox(properties_box_sizer->GetStaticBox(), wxID_ANY,
                      "Block Missiles", wxDefaultPosition, wxDefaultSize, 0);
  block_missiles->SetToolTip("Item blocks projectiles");
  properties_box_sizer->Add(block_missiles, 0, wxALL, 5);

  block_pathfinder =
      newd wxCheckBox(properties_box_sizer->GetStaticBox(), wxID_ANY,
                      "Block Pathfinder", wxDefaultPosition, wxDefaultSize, 0);
  block_pathfinder->SetToolTip("Item blocks pathfinding");
  properties_box_sizer->Add(block_pathfinder, 0, wxALL, 5);

  readable = newd wxCheckBox(properties_box_sizer->GetStaticBox(), wxID_ANY,
                             "Readable", wxDefaultPosition, wxDefaultSize, 0);
  readable->SetToolTip("Item has text");
  properties_box_sizer->Add(readable, 0, wxALL, 5);

  writeable = newd wxCheckBox(properties_box_sizer->GetStaticBox(), wxID_ANY,
                              "Writeable", wxDefaultPosition, wxDefaultSize, 0);
  writeable->SetToolTip("Item can be written on");
  properties_box_sizer->Add(writeable, 0, wxALL, 5);

  pickupable =
      newd wxCheckBox(properties_box_sizer->GetStaticBox(), wxID_ANY,
                      "Pickupable", wxDefaultPosition, wxDefaultSize, 0);
  ...
  wxStaticBoxSizer *result_box_sizer = newd wxStaticBoxSizer(
      newd wxStaticBox(this, wxID_ANY, "Result"), wxVERTICAL);
  items_list =
      newd FindDialogListBox(result_box_sizer->GetStaticBox(), wxID_ANY);
  ...
  // Connect Events
  options_radio_box->Bind(wxEVT_COMMAND_RADIOBOX_SELECTED,
                          &FindItemDialog::OnOptionChange, this);
  server_id_spin->Bind(wxEVT_COMMAND_SPINCTRL_UPDATED,
                       &FindItemDialog::OnServerIdChange, this);
  server_id_spin->Bind(wxEVT_COMMAND_TEXT_UPDATED,
                       &FindItemDialog::OnServerIdChange, this);
  client_id_spin->Bind(wxEVT_COMMAND_SPINCTRL_UPDATED,
                       &FindItemDialog::OnClientIdChange, this);
  client_id_spin->Bind(wxEVT_COMMAND_TEXT_UPDATED,
                       &FindItemDialog::OnClientIdChange, this);
  name_text_input->Bind(wxEVT_COMMAND_TEXT_UPDATED, &FindItemDialog::OnText,
                        this);

  types_radio_box->Bind(wxEVT_COMMAND_RADIOBOX_SELECTED,
                        &FindItemDialog::OnTypeChange, this);

  unpassable->Bind(wxEVT_COMMAND_CHECKBOX_CLICKED,
                   &FindItemDialog::OnPropertyChange, this);
  unmovable->Bind(wxEVT_COMMAND_CHECKBOX_CLICKED,
                  &FindItemDialog::OnPropertyChange, this);
  block_missiles->Bind(wxEVT_COMMAND_CHECKBOX_CLICKED,
                       &FindItemDialog::OnPropertyChange, this);
  block_pathfinder->Bind(wxEVT_COMMAND_CHECKBOX_CLICKED,
                         &FindItemDialog::OnPropertyChange, this);
  readable->Bind(wxEVT_COMMAND_CHECKBOX_CLICKED,
                 &FindItemDialog::OnPropertyChange, this);
  writeable->Bind(wxEVT_COMMAND_CHECKBOX_CLICKED,
                  &FindItemDialog::OnPropertyChange, this);
  pickupable->Bind(wxEVT_COMMAND_CHECKBOX_CLICKED,
                   &FindItemDialog::OnPropertyChange, this);
  stackable->Bind(wxEVT_COMMAND_CHECKBOX_CLICKED,
                  &FindItemDialog::OnPropertyChange, this);
  rotatable->Bind(wxEVT_COMMAND_CHECKBOX_CLICKED,
                  &FindItemDialog::OnPropertyChange, this);
  hangable->Bind(wxEVT_COMMAND_CHECKBOX_CLICKED,
                 &FindItemDialog::OnPropertyChange, this);
  hook_east->Bind(wxEVT_COMMAND_CHECKBOX_CLICKED,
                  &FindItemDialog::OnPropertyChange, this);
  hook_south->Bind(wxEVT_COMMAND_CHECKBOX_CLICKED,
                   &FindItemDialog::OnPropertyChange, this);
  has_elevation->Bind(wxEVT_COMMAND_CHECKBOX_CLICKED,
                      &FindItemDialog::OnPropertyChange, this);
  ignore_look->Bind(wxEVT_COMMAND_CHECKBOX_CLICKED,
                    &FindItemDialog::OnPropertyChange, this);
  floor_change->Bind(wxEVT_COMMAND_CHECKBOX_CLICKED,
                     &FindItemDialog::OnPropertyChange, this);
  invalid_item->Bind(wxEVT_COMMAND_CHECKBOX_CLICKED,
                     &FindItemDialog::OnPropertyChange, this);
...
FindItemDialog::~FindItemDialog() {
  // Events are automatically unbound when the object is destroyed or when Bind
  // target is destroyed.
}
...
void FindItemDialog::RefreshContentsInternal() {
  ...
  auto *atlas = g_gui.atlas_lifecycle.getAtlasManager();
  ...
  if (selection == SearchMode::ServerIDs) {
    ...
    if (search_string.size() >= 2) {
      for (int id = 100; id <= g_items.getMaxID(); ++id) {
        ...
        if (as_lower_str(raw_brush->getName()).find(search_string) ==
            std::string::npos) {
          continue;
        }
    ...
    for (int id = 100; id <= g_items.getMaxID(); ++id) {
      ...
      SearchItemType selection =
          (SearchItemType)types_radio_box->GetSelection();
    ...
    bool has_selected = (unpassable->GetValue() || unmovable->GetValue() ||
                         block_missiles->GetValue() ||
                         block_pathfinder->GetValue() || readable->GetValue() ||
                         writeable->GetValue() || pickupable->GetValue() ||
                         stackable->GetValue() || rotatable->GetValue() ||
                         hangable->GetValue() || hook_east->GetValue() ||
                         hook_south->GetValue() || has_elevation->GetValue() ||
                         ignore_look->GetValue() || floor_change->GetValue());
