...
FindItemDialog::FindItemDialog(wxWindow* parent, const wxString& title, bool onlyPickupables /* = false*/) :
	...
	options_radio_box->SetToolTip("Search mode");
	...
	invalid_item->SetToolTip("Force choose item ID that does not appear on the list. (Alt+F)");
	...
	types_radio_box->SetToolTip("Search by category");
	...
	pickupable = newd wxCheckBox(properties_box_sizer->GetStaticBox(), wxID_ANY, "P&ickupable", wxDefaultPosition, wxDefaultSize, 0);
	...
	rotatable = newd wxCheckBox(properties_box_sizer->GetStaticBox(), wxID_ANY, "R&otatable", wxDefaultPosition, wxDefaultSize, 0);
	...
	has_elevation = newd wxCheckBox(properties_box_sizer->GetStaticBox(), wxID_ANY, "Has E&levation", wxDefaultPosition, wxDefaultSize, 0);
	has_elevation->SetToolTip("Item has height (elevation)");
	properties_box_sizer->Add(has_elevation, 0, wxALL, 5);

	ignore_look = newd wxCheckBox(properties_box_sizer->GetStaticBox(), wxID_ANY, "I&gnore Look", wxDefaultPosition, wxDefaultSize, 0);
	ignore_look->SetToolTip("Item is ignored when looking");
	properties_box_sizer->Add(ignore_look, 0, wxALL, 5);

	floor_change = newd wxCheckBox(properties_box_sizer->GetStaticBox(), wxID_ANY, "F&loor Change", wxDefaultPosition, wxDefaultSize, 0);
