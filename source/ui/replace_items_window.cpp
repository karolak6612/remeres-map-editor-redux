...
ReplaceItemsListBox::ReplaceItemsListBox(wxWindow* parent) : NanoVGListBox(parent, wxID_ANY, wxLB_SINGLE), m_arrow_image(0), m_flag_image(0)
{
}
...
ReplaceItemsDialog::ReplaceItemsDialog(wxWindow* parent, bool selectionOnly) :
    wxDialog(
        parent, wxID_ANY, (selectionOnly ? "Replace Items on Selection" : "Replace Items"), wxDefaultPosition, wxDefaultSize,
