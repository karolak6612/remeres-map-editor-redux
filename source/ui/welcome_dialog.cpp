...
private:
	...
	void OnPaint(wxPaintEvent& evt) {
		...
		wxBitmap bmp;
		if (m_icon.IsOk()) {
			bmp = m_icon.GetBitmap(FromDIP(m_icon.GetDefaultSize()));
		}
...
wxPanel* WelcomeDialog::CreateHeaderPanel(wxWindow* parent, const wxString& titleText, const wxBitmap& rmeLogo) {
	...
	if (rmeLogo.IsOk()) {
		iconBtn->SetBitmapBundle(wxBitmapBundle::FromBitmap(rmeLogo));
	} else {
		iconBtn->SetBitmapBundle(IMAGE_MANAGER.GetBitmapBundle(ICON_QUESTION_CIRCLE));
	}
	...
	prefBtn->SetBitmapBundle(IMAGE_MANAGER.GetBitmapBundle(ICON_GEAR));
...
wxPanel* WelcomeDialog::CreateFooterPanel(wxWindow* parent, const wxString& versionText) {
	...
	exitBtn->SetBitmapBundle(IMAGE_MANAGER.GetBitmapBundle(ICON_POWER_OFF));
	...
	newBtn->SetBitmapBundle(IMAGE_MANAGER.GetBitmapBundle(ICON_NEW));
	...
	loadBtn->SetBitmapBundle(IMAGE_MANAGER.GetBitmapBundle(ICON_OPEN));
...
wxPanel* WelcomeDialog::CreateContentPanel(wxWindow* parent, const std::vector<wxString>& recentFiles) {
	...
	newMapBtn->SetBitmapBundle(IMAGE_MANAGER.GetBitmapBundle(ICON_NEW));
	...
	browseBtn->SetBitmapBundle(IMAGE_MANAGER.GetBitmapBundle(ICON_OPEN));
