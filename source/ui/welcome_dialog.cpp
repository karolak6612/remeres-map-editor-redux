...
wxPanel* WelcomeDialog::CreateHeaderPanel(wxWindow* parent, const wxString& titleText, const wxBitmap& rmeLogo) {
	...
	prefBtn->SetToolTip("Open application preferences");
...
wxPanel* WelcomeDialog::CreateFooterPanel(wxWindow* parent, const wxString& versionText) {
	...
	exitBtn->SetToolTip("Close the map editor");
	...
	newBtn->SetToolTip("Create a new empty map");
	...
	loadBtn->SetToolTip("Load the selected recent map");
...
wxPanel* WelcomeDialog::CreateContentPanel(wxWindow* parent, const std::vector<wxString>& recentFiles) {
	...
	newMapBtn->SetToolTip("Create a new empty map");
	...
	browseBtn->SetToolTip("Open an existing map file");
	...
	m_recentList->SetToolTip("Double-click to load a recent map");
	...
	m_clientList->SetToolTip("Select a client version to load");
