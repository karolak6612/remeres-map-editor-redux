...
public:
    ConvexButton(
        wxWindow* parent, wxWindowID id, const wxString& label, const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxDefaultSize,
        long style = 0
    ) :
...
WelcomeDialog::WelcomeDialog(
    const wxString& titleText, const wxString& versionText, const wxSize& size, const wxBitmap& rmeLogo,
...
void WelcomeDialog::AddInfoField(
    wxSizer* sizer, wxWindow* parent, const wxString& label, const wxString& value, std::string_view artId, const wxColour& valCol
)
{
...
wxPanel* WelcomeDialog::CreateHeaderPanel(wxWindow* parent, const wxString& titleText, const wxBitmap& rmeLogo)
{
    ...
    iconBtn->SetBitmap(
        rmeLogo.IsOk() ? rmeLogo : IMAGE_MANAGER.GetBitmap(ICON_QUESTION_CIRCLE, wxSize(32, 32))
