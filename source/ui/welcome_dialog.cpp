...
wxPanel* WelcomeDialog::CreateFooterPanel(wxWindow* parent, const wxString& versionText) {
	...
	newBtn->SetToolTip("Create a new map project");
	...
	loadBtn->SetToolTip("Open an existing map file");
...
wxPanel* WelcomeDialog::CreateContentPanel(wxWindow* parent, const std::vector<wxString>& recentFiles) {
	...
	newMapBtn->SetToolTip("Create a new map project");
	...
	m_recentList->SetToolTip("Double-click a map to open it.");
