...
BrowseTileWindow::BrowseTileWindow(wxWindow* parent, Tile* tile, wxPoint position /* = wxDefaultPosition */) :
	...
	infoSizer->Add(newd wxStaticText(this, wxID_ANY, "No PvP:  " + b2yn(testFlags(tile->getMapFlags(), TileMapFlag::NoPvp))), wxSizerFlags(0).Left());
	infoSizer->Add(newd wxStaticText(this, wxID_ANY, "No logout:  " + b2yn(testFlags(tile->getMapFlags(), TileMapFlag::NoLogout))), wxSizerFlags(0).Left());
	infoSizer->Add(newd wxStaticText(this, wxID_ANY, "PvP zone:  " + b2yn(testFlags(tile->getMapFlags(), TileMapFlag::PvpZone))), wxSizerFlags(0).Left());
