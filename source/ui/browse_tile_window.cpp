...
BrowseTileWindow::BrowseTileWindow(wxWindow* parent, Tile* tile, wxPoint position /* = wxDefaultPosition */) :
	...
	infoSizer->Add(newd wxStaticText(this, wxID_ANY, "No PvP:  " + b2yn(static_cast<uint16_t>(tile->getMapFlags() & TileMapFlags::NOPVP))), wxSizerFlags(0).Left());
	infoSizer->Add(newd wxStaticText(this, wxID_ANY, "No logout:  " + b2yn(static_cast<uint16_t>(tile->getMapFlags() & TileMapFlags::NOLOGOUT))), wxSizerFlags(0).Left());
	infoSizer->Add(newd wxStaticText(this, wxID_ANY, "PvP zone:  " + b2yn(static_cast<uint16_t>(tile->getMapFlags() & TileMapFlags::PVPZONE))), wxSizerFlags(0).Left());
