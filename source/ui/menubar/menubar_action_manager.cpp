...
#define MAKE_SET_ACTION(id, kind, setting_, handler)                                                                \
	...
	MAKE_ACTION_ICON(SEARCH_ON_MAP_UNIQUE, wxITEM_NORMAL, ICON_STAR, OnSearchForUniqueOnMap);
	MAKE_ACTION_ICON(SEARCH_ON_MAP_ACTION, wxITEM_NORMAL, ICON_BOLT, OnSearchForActionOnMap);
	MAKE_ACTION_ICON(SEARCH_ON_MAP_CONTAINER, wxITEM_NORMAL, ICON_BOX, OnSearchForContainerOnMap);
	MAKE_ACTION_ICON(SEARCH_ON_MAP_WRITEABLE, wxITEM_NORMAL, ICON_PEN, OnSearchForWriteableOnMap);
	MAKE_ACTION_ICON(SEARCH_ON_SELECTION_EVERYTHING, wxITEM_NORMAL, ICON_SEARCH, OnSearchForStuffOnSelection);
	MAKE_ACTION_ICON(SEARCH_ON_SELECTION_UNIQUE, wxITEM_NORMAL, ICON_STAR, OnSearchForUniqueOnSelection);
	MAKE_ACTION_ICON(SEARCH_ON_SELECTION_ACTION, wxITEM_NORMAL, ICON_BOLT, OnSearchForActionOnSelection);
	MAKE_ACTION_ICON(SEARCH_ON_SELECTION_CONTAINER, wxITEM_NORMAL, ICON_BOX, OnSearchForContainerOnSelection);
	MAKE_ACTION_ICON(SEARCH_ON_SELECTION_WRITEABLE, wxITEM_NORMAL, ICON_PEN, OnSearchForWriteableOnSelection);
	MAKE_ACTION_ICON(SEARCH_ON_SELECTION_ITEM, wxITEM_NORMAL, ICON_MAGNIFYING_GLASS_PLUS, OnSearchForItemOnSelection);
	...
	MAKE_ACTION_ICON(WIN_TILE_PROPERTIES, wxITEM_NORMAL, ICON_INFO, OnTilePropertiesWindow);
