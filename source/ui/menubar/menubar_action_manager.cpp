...
#define MAKE_SET_ACTION(id, kind, setting_, handler)                                                                \
	...
	MAKE_ACTION_ICON(FLOOR_10, wxITEM_RADIO, ICON_A, OnChangeFloor);
	MAKE_ACTION_ICON(FLOOR_11, wxITEM_RADIO, ICON_B, OnChangeFloor);
	MAKE_ACTION_ICON(FLOOR_12, wxITEM_RADIO, ICON_C, OnChangeFloor);
	MAKE_ACTION_ICON(FLOOR_13, wxITEM_RADIO, ICON_D, OnChangeFloor);
	MAKE_ACTION_ICON(FLOOR_14, wxITEM_RADIO, ICON_E, OnChangeFloor);
	MAKE_ACTION_ICON(FLOOR_15, wxITEM_RADIO, ICON_F, OnChangeFloor);
