...
#define MAKE_SET_ACTION(id, kind, setting_, handler)                                                                \
	...
	MAKE_ACTION_ICON(FLOOR_10, wxITEM_RADIO, ICON_10, OnChangeFloor);
	MAKE_ACTION_ICON(FLOOR_11, wxITEM_RADIO, ICON_11, OnChangeFloor);
	MAKE_ACTION_ICON(FLOOR_12, wxITEM_RADIO, ICON_12, OnChangeFloor);
	MAKE_ACTION_ICON(FLOOR_13, wxITEM_RADIO, ICON_13, OnChangeFloor);
	MAKE_ACTION_ICON(FLOOR_14, wxITEM_RADIO, ICON_14, OnChangeFloor);
	MAKE_ACTION_ICON(FLOOR_15, wxITEM_RADIO, ICON_15, OnChangeFloor);
