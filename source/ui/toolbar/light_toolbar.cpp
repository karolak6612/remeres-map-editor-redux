...
LightToolBar::LightToolBar(wxWindow* parent) {
	...
	intensity_label->SetToolTip("Controls the global light intensity");
	...
	ambient_label->SetToolTip("Controls the ambient light level (darkness)");
	...
	toolbar->AddTool(ID_LIGHT_TOGGLE, "Toggle Lighting", light_bitmap, "Toggle Lighting (Show/Hide lights)", wxITEM_CHECK);
