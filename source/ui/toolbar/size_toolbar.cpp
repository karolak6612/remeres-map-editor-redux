...
SizeToolBar::SizeToolBar(wxWindow* parent) {
	...
	toolbar->AddTool(TOOLBAR_SIZES_RECTANGULAR, wxEmptyString, rectangular_bitmap, wxNullBitmap, wxITEM_CHECK, "Rectangular Brush (R)", wxEmptyString, nullptr);
	toolbar->AddTool(TOOLBAR_SIZES_CIRCULAR, wxEmptyString, circular_bitmap, wxNullBitmap, wxITEM_CHECK, "Circular Brush (C)", wxEmptyString, nullptr);
