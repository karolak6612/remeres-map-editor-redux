...
void MapFlagsPanel::SetTile(Tile* tile, Map* map) {
	...
	if (tile) {
		...
		chk_nopvp->SetValue(testFlags(tile->getMapFlags(), TileMapFlag::NoPvp));
		chk_nologout->SetValue(testFlags(tile->getMapFlags(), TileMapFlag::NoLogout));
		chk_pvpzone->SetValue(testFlags(tile->getMapFlags(), TileMapFlag::PvpZone));
