...
SpawnCreaturePanel::SpawnCreaturePanel(wxWindow* parent) : wxPanel(parent, wxID_ANY)
{
    ...
    spawn_bitmap = newd wxStaticBitmap(
        main_sizer->GetStaticBox(), wxID_ANY, wxNullBitmap, wxDefaultPosition, FROM_DIP(this, wxSize(32, 32)), wxBORDER_SIMPLE
    );
    spawn_bitmap->Hide();
