...
<required_reading>
Read `C:/Users/Marcelo Henrique/noctmapeditor/.claude/get-shit-done/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>
