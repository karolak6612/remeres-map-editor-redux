...
```
Agent(
  prompt="Read C:/Users/Marcelo Henrique/noctmapeditor/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/Marcelo Henrique/noctmapeditor/.claude/get-shit-done/templates/VALIDATION.md`
