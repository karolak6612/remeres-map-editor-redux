...
```bash
INIT=$(node "C:/Users/Marcelo Henrique/noctmapeditor/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/Users/Marcelo Henrique/noctmapeditor/.claude/get-shit-done/templates/spec.md.
